...
class WardrobeItem(Base):
    ...
    image_mime_type: Mapped[str | None] = mapped_column(String(length=100), nullable=True)
    image_checksum: Mapped[str | None] = mapped_column(String(length=128), nullable=True)
...
class ItemTag(Base):
    ...
    item_id: Mapped[uuid.UUID] = mapped_column(GUID(), ForeignKey("wardrobe_items.id"), nullable=False)
